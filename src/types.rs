...
pub trait RequestMessage<T, U>: ToProtobuf<T> where Self::Reply: FromProtobuf<U> {
    type Reply;
}
    ...
    where U: FromProtobuf<T>
{
    fn from_protobuf(t: Vec<T>) -> Result<Self, failure::Error> {
        Ok(t.into_iter().map(|e| FromProtobuf::from_protobuf(e).unwrap()).collect())
    }
}
...
pub struct RequestCreateGame {
    ...
    #[Get] pub random_seed: Option<u32>,
    /// If set, the game plays in real time
    #[Get] pub realtime: bool,
}
...
pub struct PlayerInfo {
    #[Get] pub player_id: u32,
    #[Get] pub field_type: protos::PlayerType,
    #[Get] pub race_requested: protos::Race,
    /// Only populated for your player or when watching replay
    #[Get] pub race_actual: Option<protos::Race>,
    #[Get] pub difficulty: protos::Difficulty
}
...
pub struct RequestData {
    #[Get] pub ability_id: bool,
    #[Get] pub unit_type_id: bool,
    #[Get] pub upgrade_id: bool,
    #[Get] pub buff_id: bool,
    #[Get] pub effect_id: bool,
}
...
pub struct AbilityData {
    ...
    #[Get] remaps_to_ability_id: u32,

    #[Get] target: protos::AbilityData_Target,

    /// If true, the ability may be used on this set of mods/map
    #[Get] available: bool,

    #[Get] allow_minimap: bool,
    #[Get] allow_autocast: bool,
    #[Get] is_building: bool,
    #[Get] footprint_radius: f32,
    #[Get] is_instant_placement: bool,
    #[Get] cast_range: f32
}
...
pub struct UnitTypeData {
    ...
    #[Get] available: bool,
    #[Get] cargo_size: u32,
    #[Get] mineral_cost: u32,
    #[Get] vespene_cost: u32,
    #[Get] food_required: f32,
    #[Get] food_provided: f32,
    /// The ability that builds this unit
    #[Get] ability_id: u32,
    #[Get] race: protos::Race,
    #[Get] build_time: f32,
    #[Get] has_vespene: bool,
    #[Get] has_minerals: bool,
    /// Other units that satisfy the same tech requirement
    tech_alias: Vec<u32>,
    /// The morphed variant of this unit
    #[Get] unit_alias: u32,
    #[Get] tech_requirement: u32,
    #[Get] require_attached: bool,

    attributes: Vec<protos::Attribute>,
    #[Get] movement_speed: f32,
    #[Get] armor: f32,
    weapons: Vec<Weapon>
}
...
#[derive(Debug, FromProtobuf)]
pub struct Weapon {
    #[Get] field_type: protos::Weapon_TargetType,
    #[Get] damage: f32,
...
pub struct DamageBonus {
    #[Get] attribute: protos::Attribute,
    #[Get] bonus: f32
}
...
pub struct ActionChat {
    #[Get] channel: protos::ActionChat_Channel,
    message: String
}
...
pub enum ActionRawUnitCommandTargetEnum {
    ...
    #[Get] TargetUnitTag(u64)
}

#[derive(Debug,FromProtobuf)]
pub struct ActionRawUnitCommand {
    #[Get] ability_id: i32,
    #[OneOf] target: ActionRawUnitCommandTargetEnum,
    unit_tags: Vec<u64>,
...
pub struct ActionError {
    ...
    #[Get] unit_tag: Option<u64>,
    #[Get] ability_id: u64,
    #[Get] result: protos::ActionResult
}
...
pub struct PlayerCommon {
    ...
    #[Get] food_used: u32,
    #[Get] food_army: u32,
    #[Get] food_workers: u32,
    #[Get] idle_worker_count: u32,
    #[Get] army_count: u32,
    #[Get] warp_gate_count: u32,
    #[Get] larva_count: u32
}
...
#[derive(Debug,FromProtobuf)]
pub struct Unit {
    #[Get] display_type: protos::DisplayType,
    #[Get] alliance: protos::Alliance,
    ...
    #[Get] radius: f32,
    /// Range 0.0 to 1.0
    #[Get] build_progress: f32,
    #[Get] cloak: protos::CloakState,

    #[Get] detect_range: f32,
    #[Get] radar_range: f32,

    #[Get] is_selected: bool,
    /// Visible and within the camera frustrum
    #[Get] is_on_screen: bool,
    /// Detected by sensor tower
    #[Get] is_blip: bool,
    #[Get] is_powered: bool,

    // Not populated for snapshots:
    #[Get] health: Option<f32>,
    #[Get] health_max: Option<f32>,
    #[Get] shield: Option<f32>,
    #[Get] shield_max: Option<f32>,
    #[Get] energy: Option<f32>,
    #[Get] energy_max: Option<f32>,
    #[Get] mineral_contents: Option<i32>,
    #[Get] vespene_contents: Option<i32>,
    #[Get] is_flying: Option<bool>,
    #[Get] is_burrowed: Option<bool>,

    // Not populated for enemies:
    orders: Vec<UnitOrder>,
    #[Get] add_on_tag: Option<u64>,
    passengers: Vec<PassengerUnit>,
    #[Get] cargo_space_taken: Option<i32>,
    #[Get] cargo_space_max: Option<i32>,
    buff_ids: Vec<u32>,
    #[Get] assigned_harvesters: Option<i32>,
    #[Get] ideal_harvesters: Option<i32>,
    #[Get] weapon_cooldown: Option<f32>,
    #[Get] engaged_target_tag: Option<u64>,
...
pub struct Observation {
    ...
    raw_data: Option<ObservationRaw>
...
#[derive(Debug,FromProtobuf)]
pub struct Response {
    #[OneOf] pub response: ResponseEnum,
    pub error: Vec<String>,
    #[Get] pub status: Option<Status>
}
